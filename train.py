...
# Training settings
D_DATA = "E:/downloads/PycharmProjects_E/pix2pix-pytorch/dataset"
parser = argparse.ArgumentParser(description='pix2pix-pytorch-implementation')
parser.add_argument('--display_port', type=int, default=8097, help='visdom port of the web display')
parser.add_argument('--display_env', type=str, default='pix2pix', help='visdom display environment name (default is "main")')
